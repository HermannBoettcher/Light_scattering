...
\begin{abstract}
  In the experiment, we determine the gravitational force and the lightforce on a colloidal particle trapped by an optical tweezer seperately. Furthemrore, 
\end{abstract}
