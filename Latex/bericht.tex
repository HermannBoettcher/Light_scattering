...
\begin{abstract}
  In the experiment, we determine the gravitational force and the lightforce on a colloidal particle trapped by an optical tweezer seperately. Furthermore, the form f the potential for colloidal particles in an aqueous solution is derived and presented.  
\end{abstract}
