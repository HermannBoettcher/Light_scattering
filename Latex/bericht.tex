...
\documentclass[nenglish, 11pt, rgb]{scrreprt}
...
\usepackage{sty/themeKonstanz} % Muss immer verwendet werden (Standardpaket)
...
\date{19.12.2018}
\year{2018}
\author{Hermann Böttcher \& Jannik Dornseiff}
\title{Evaneszente Lichtstreuung}
\unisection{Mathematisch-Naturwissenschaftlichen Sektion}
\department{Fachbereich Physik}
\supervisorOne{Hugo Wendehenne}
...
\begin{abstract}
  In the experiment, we determine the gravitational force and the lightforce on a colloidal particle trapped by an optical tweezer seperately. Furthermore, the form of the potential for colloidal particles in an aqueous solution is derived and presented.
\end{abstract}
...
\subfile{kapitel/versuchsauswertung.tex}
